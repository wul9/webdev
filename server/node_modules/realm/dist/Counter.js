...
class Counter {
    ...
    [COLUMN_KEY];
    /** @internal */
    constructor(realm, obj, columnKey) {
        if (!(realm instanceof internal_1.Realm) || !(obj instanceof internal_1.binding.Obj)) {
            throw new internal_1.IllegalConstructorError("Counter");
        }
        this[REALM] = realm;
        this[OBJ] = obj;
    ...
    get value() {
        try {
            ...
            internal_1.assert.isValid(this[OBJ]);
            throw err;
        }
    }
    /** @internal */
    ...
    increment(by = 1) {
        ...
        internal_1.assert.integer(by, "by");
        this[OBJ].addInt(this[COLUMN_KEY], internal_1.binding.Int64.numToInt(by));
    }
    /**
     * Decrement the count.
    ...
    set(value) {
        internal_1.assert.inTransaction(this[REALM]);
        internal_1.assert.integer(value, "value");
        this[OBJ].setAny(this[COLUMN_KEY], internal_1.binding.Int64.numToInt(value));
    }
}
