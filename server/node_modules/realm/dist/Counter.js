...
class Counter {
    ...
    constructor(realm, obj, columnKey) {
        if (!(obj instanceof binding_1.binding.Obj)) {
            throw new errors_1.IllegalConstructorError("Counter");
        }
        this[REALM] = realm;
        this[OBJ] = obj;
    ...
    get value() {
        try {
            ...
            assert_1.assert.isValid(this[OBJ]);
            throw err;
        }
    }
    /** @internal */
    ...
    increment(by = 1) {
        ...
        assert_1.assert.integer(by, "by");
        this[OBJ].addInt(this[COLUMN_KEY], binding_1.binding.Int64.numToInt(by));
    }
    /**
     * Decrement the count.
    ...
    set(value) {
        assert_1.assert.inTransaction(this[REALM]);
        assert_1.assert.integer(value, "value");
        this[OBJ].setAny(this[COLUMN_KEY], binding_1.binding.Int64.numToInt(value));
    }
}
