...
class PropertyMap {
    ...
    initialize(objectSchema, canonicalObjectSchema, defaults, options) {
        ...
        this.mapping = Object.fromEntries(properties.map((property) => {
            ...
            (0, internal_1.assert)(canonicalPropertySchema, `Expected '${propertyName}' to exist on the CanonicalObjectSchema.`);
            const helpers = (0, internal_1.createPropertyHelpers)({ ...property, embedded, objectSchemaName, presentation: canonicalPropertySchema.presentation }, options);
