...
class ClassMap {
    ...
    static createClass(schema, constructor) {
        ...
        if (constructor) {
            ...
            Object.setPrototypeOf(result, internal_1.RealmObject);
            Object.setPrototypeOf(result.prototype, internal_1.RealmObject.prototype);
        }
        return result;
    }
    static defineProperties(constructor, schema, propertyMap, realm) {
        ...
        for (const property of properties) {
            ...
            Object.defineProperty(constructor.prototype, propertyName, {
                enumerable: true,
                get() {
                    return get(this[internal_1.INTERNAL]);
                },
                set(value) {
                    set(this[internal_1.INTERNAL], value);
                },
            });
        }
        Object.defineProperty(constructor.prototype, internal_1.REALM, {
            enumerable: false,
            configurable: false,
            writable: false,
            value: realm,
        });
        Object.defineProperty(constructor.prototype, internal_1.KEY_ARRAY, {
            enumerable: false,
            configurable: false,
            writable: false,
            value: propertyNames,
        });
        Object.defineProperty(constructor.prototype, internal_1.KEY_SET, {
            enumerable: false,
            configurable: false,
            writable: false,
    ...
    constructor(realm, realmSchema, canonicalRealmSchema) {
        this.mapping = Object.fromEntries(realmSchema.map((objectSchema, index) => {
            ...
            internal_1.assert.object(canonicalObjectSchema);
            ...
            const properties = new internal_1.PropertyMap();
            // Setting the helpers on the class
            (0, internal_1.setClassHelpers)(constructor, {
                constructor,
                objectSchema,
                ...
                wrapObject(obj) {
                    if (obj.isValid) {
                        return internal_1.RealmObject.createWrapper(obj, constructor);
                    }
                    else {
                        return null;
                    }
        ...
        for (const [index, objectSchema] of realmSchema.entries()) {
            ...
            const { properties } = (0, internal_1.getClassHelpers)(constructor);
    ...
    get(arg) {
        ...
        else if (arg instanceof internal_1.RealmObject) {
            return this.get(arg.constructor.name);
        }
        else if (typeof arg === "function") {
            internal_1.assert.extends(arg, internal_1.RealmObject);
            internal_1.assert.object(arg.schema, "schema static");
            internal_1.assert.string(arg.schema.name, "name");
            const result = this.get(arg.schema.name);
            (0, internal_1.assert)(result === arg || Object.getPrototypeOf(result) === arg, "Constructor was not registered in the schema for this Realm");
            return result;
        }
    ...
    getHelpers(arg) {
        ...
        return (0, internal_1.getClassHelpers)(constructor);
    }
}
