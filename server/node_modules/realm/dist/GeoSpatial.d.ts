...
/** @internal */
export declare function isGeoCircle(value: object): value is GeoCircle;
/** @internal */
export declare function isGeoBox(value: object): value is GeoBox;
/** @internal */
export declare function isGeoPolygon(value: object): value is GeoPolygon;
/** @internal */
export declare function circleToBindingGeospatial(circle: GeoCircle): binding.Geospatial;
/** @internal */
export declare function boxToBindingGeospatial(box: GeoBox): binding.Geospatial;
/** @internal */
export declare function polygonToBindingGeospatial(polygon: GeoPolygon): binding.Geospatial;
/**
