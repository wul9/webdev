...
class ApiKeyAuth {
     ...
     */
    async fetch(keyId) {
        const { id, name, disabled } = await this.internal.fetchApiKey(new bson_1.BSON.ObjectId(keyId), this.user);
     ...
     */
    async delete(keyId) {
        await this.internal.deleteApiKey(new bson_1.BSON.ObjectId(keyId), this.user);
    }
    /**
     ...
     */
    async enable(keyId) {
        await this.internal.enableApiKey(new bson_1.BSON.ObjectId(keyId), this.user);
    }
    /**
     ...
     */
    async disable(keyId) {
        await this.internal.disableApiKey(new bson_1.BSON.ObjectId(keyId), this.user);
    }
}
