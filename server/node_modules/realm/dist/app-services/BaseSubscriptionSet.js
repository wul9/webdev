...
class BaseSubscriptionSet {
    ...
    findByName(name) {
        ...
        return subscription ? new Subscription_1.Subscription(subscription) : null;
    }
    /**
    ...
    findByQuery(query) {
        ...
        return subscription ? new Subscription_1.Subscription(subscription) : null; // TODO: Remove the type assertion into Subscription
    }
    /** @internal */
    exists(query) {
    ...
    *[Symbol.iterator]() {
        for (const subscription of this.internal) {
            yield new Subscription_1.Subscription(subscription);
        }
    }
    /**
