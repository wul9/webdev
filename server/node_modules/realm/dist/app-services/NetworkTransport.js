...
const debug = (0, debug_1.extendDebug)("network");
...
/** @internal */
function createNetworkTransport(fetch = platform_1.network.fetch) {
    return binding_1.binding.Helpers.makeNetworkTransport((request, callback) => {
        const [url, init] = binding_1.binding.toFetchArgs(request);
