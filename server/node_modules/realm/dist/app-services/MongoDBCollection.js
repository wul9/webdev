...
class MongoDBCollection {
    ...
    /** @internal */ user, serviceName, databaseName, collectionName) {
        ...
        this.functions = (0, FunctionsFactory_1.createFactory)(user, serviceName);
    }
    /**
    ...
    async *watch({ ids, filter, } = {}) {
        ...
        const watchStream = binding_1.binding.WatchStream.make();
        for await (const chunk of iterator) {
            if (!chunk)
                continue;
            // TODO: Remove `toArrayBuffer()` once https://jira.mongodb.org/browse/RJS-2124 gets solved
            const buffer = (0, array_buffer_1.toArrayBuffer)(chunk);
            binding_1.binding.Helpers.feedBuffer(watchStream, buffer);
