...
class App {
    ...
    static setAppByUser(userInternal, currentApp) {
        App.appByUserId.set(userInternal.userId, new internal_1.binding.WeakRef(currentApp));
    }
    /** @internal */
    internal;
    ...
    constructor(configOrId) {
        ...
        this.internal = internal_1.binding.App.getApp(0 /* binding.AppCacheMode.Enabled */, {
            appId: id,
     ...
     */
    get allUsers() {
        return Object.fromEntries(this.internal.allUsers.map((user) => [user.userId, internal_1.User.get(user, this)]));
    }
    /**
