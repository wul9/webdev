...
exports.miToRadians = exports.kmToRadians = exports.polygonToBindingGeospatial = exports.boxToBindingGeospatial = exports.circleToBindingGeospatial = exports.isGeoPolygon = exports.isGeoBox = exports.isGeoCircle = void 0;
const binding_1 = require("./binding");
/** @internal */
function isGeoCircle(value) {
    return "center" in value && "distance" in value && typeof value.distance === "number";
}
exports.isGeoCircle = isGeoCircle;
/** @internal */
function isGeoBox(value) {
    return "bottomLeft" in value && "topRight" in value;
}
exports.isGeoBox = isGeoBox;
/** @internal */
...
exports.isGeoPolygon = isGeoPolygon;
/** @internal */
function circleToBindingGeospatial(circle) {
    return binding_1.binding.Geospatial.makeFromCircle({
...
function boxToBindingGeospatial(box) {
    return binding_1.binding.Geospatial.makeFromBox({
...
function polygonToBindingGeospatial(polygon) {
    ...
    return binding_1.binding.Geospatial.makeFromPolygon({
        points,
    });
}
